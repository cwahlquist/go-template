...
func (*ServiceCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b7f239db831c052d, []int{0}
}
...
func (dst *ServiceCommand) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceCommand.Merge(dst, src)
}
...
func (*Id) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b7f239db831c052d, []int{1}
}
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_b7f239db831c052d) }

var fileDescriptor_service_b7f239db831c052d = []byte{
